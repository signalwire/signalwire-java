 ...
 *
 * <p>Only the proxy-override branch can be reliably exercised from tests (env-var-driven branches
 * depend on the real process env, which Java cannot mutate without reflection hacks). The Lambda

 ...
 *
 * <p>Tests use a map-backed {@link EnvProvider} rather than real OS environment variables, because
 * Java does not permit mutating the process env without reflection hacks.
 */
class ExecutionModeTest {
  ...
  void googleCloudFunctionDetected() {
    assertEquals(
        ExecutionMode.GOOGLE_CLOUD_FUNCTION,

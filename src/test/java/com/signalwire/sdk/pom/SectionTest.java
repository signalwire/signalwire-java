...
/**
 * Java parity tests for {@link Section}, mirroring {@code
 * signalwire-python/tests/unit/pom/test_pom_object_model.py::TestSectionBasics} and the byte-exact
 * rendered shapes from {@code signalwire/pom/pom.py}.
 */
class SectionTest {

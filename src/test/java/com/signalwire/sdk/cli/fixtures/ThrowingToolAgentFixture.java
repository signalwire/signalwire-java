...
/**
 * Test-only agent whose {@code explode} tool throws. Used to confirm the simulator's {@code
 * try/finally} restoration runs on the exception path as well as the success path.
 */

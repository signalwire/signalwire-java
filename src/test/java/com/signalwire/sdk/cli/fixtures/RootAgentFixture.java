 ...
 *
 * <p>Exposes both a no-arg factory and an {@link EnvProvider}-aware factory so we can verify both
 * reflection signatures the CLI loader accepts.
 */
public class RootAgentFixture {
  ...
  /**
   * EnvProvider-aware factory — the preferred signature. Exercises the path where simulated values
   * are visible to the builder.
   */

...
class CompatMessagesFaxesMockTest {
  ...
  class MessagesUpdate {
    ...
    void returnsMessageResource() {
      ...
      assertTrue(
          result.containsKey("body") || result.containsKey("sid"),
    ...
    void journalRecordsPostToMessage() {
      ...
      assertEquals(acctBase + "/Messages/MM_U1", j.path);
  ...
  class MessagesGetMedia {
    ...
    void returnsMediaResource() {
      ...
      assertTrue(
          result.containsKey("content_type") || result.containsKey("sid"),
    ...
    void journalRecordsGetToMediaPath() {
      ...
      assertEquals(acctBase + "/Messages/MM_X/Media/ME_X", j.path);
    }
  }
  ...
  class MessagesDeleteMedia {
    ...
    void journalRecordsDelete() {
      ...
      assertEquals(acctBase + "/Messages/MM_D/Media/ME_D", j.path);
    }
  }
  ...
  class FaxesUpdate {
    ...
    void returnsFaxResource() {
      ...
      assertTrue(
          result.containsKey("status") || result.containsKey("direction"),
    ...
    void journalRecordsPostWithStatus() {
      ...
      MockTest.JournalEntry j = mock.last();
      assertEquals("POST", j.method);
      assertEquals(acctBase + "/Faxes/FX_U2", j.path);
      Map<String, Object> jb = j.bodyMap();
      assertNotNull(jb);
      assertEquals("canceled", jb.get("Status"));
    }
  ...
  class FaxesListMedia {
    ...
    void returnsPaginatedList() {
      ...
      assertTrue(
          result.containsKey("media") || result.containsKey("fax_media"),
    ...
    void journalRecordsGetToFaxMedia() {
      ...
      MockTest.JournalEntry j = mock.last();
      assertEquals("GET", j.method);
      assertEquals(acctBase + "/Faxes/FX_LM_X/Media", j.path);
    }
  }
  ...
  class FaxesGetMedia {
    ...
    void journalRecordsGetToSpecificMedia() {
      ...
      MockTest.JournalEntry j = mock.last();
      assertEquals("GET", j.method);
      assertEquals(acctBase + "/Faxes/FX_G/Media/ME_G", j.path);
    }
  }
  ...
  class FaxesDeleteMedia {
    ...
    void journalRecordsDelete() {
      ...
      MockTest.JournalEntry j = mock.last();
      assertEquals("DELETE", j.method);
      assertEquals(acctBase + "/Faxes/FX_D/Media/ME_D", j.path);
    }
  }
}

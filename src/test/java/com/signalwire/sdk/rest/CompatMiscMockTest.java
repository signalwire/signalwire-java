...
/**
 * Mock-backed unit tests translated from signalwire-python/tests/unit/rest/test_compat_misc.py.
 *
 * <p>Covers single-method gaps in compat sub-resources: {@code applications.update} and {@code
 * lamlBins.update}.
 */
class CompatMiscMockTest {
  ...
  class ApplicationsUpdate {
    ...
    void returnsApplication() {
      Map<String, Object> result =
          client.compat().applications().update("AP_U", kw("FriendlyName", "updated"));
    ...
    void journalRecordsPost() {
      client
          .compat()
          .applications()
          .update("AP_UU", kw("FriendlyName", "renamed", "VoiceUrl", "https://a.b/v"));
  ...
  class LamlBinsUpdate {
    ...
    void returnsLamlBin() {
      Map<String, Object> result =
          client.compat().lamlBins().update("LB_U", kw("FriendlyName", "updated"));
      assertNotNull(result);
      assertTrue(
          result.containsKey("friendly_name")
    ...
    void journalRecordsPost() {
      client
          .compat()
          .lamlBins()
          .update("LB_UU", kw("FriendlyName", "renamed", "Contents", "<Response/>"));
      MockTest.JournalEntry j = mock.last();
      assertEquals("POST", j.method);

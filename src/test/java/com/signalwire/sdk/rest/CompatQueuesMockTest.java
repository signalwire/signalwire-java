...
/**
 * Mock-backed unit tests translated from signalwire-python/tests/unit/rest/test_compat_queues.py.
 *
...
class CompatQueuesMockTest {
  ...
  class Update {
    ...
    void returnsQueue() {
      Map<String, Object> result =
          client.compat().queues().update("QU_U", kw("FriendlyName", "updated"));
      assertNotNull(result);
      assertTrue(
          result.containsKey("friendly_name") || result.containsKey("sid"),
    ...
    void journalRecordsPost() {
      client.compat().queues().update("QU_UU", kw("FriendlyName", "renamed", "MaxSize", 200));
  ...
  class ListMembers {
    ...
    void returnsMembers() {
      ...
      assertNotNull(result);
      assertTrue(
          result.containsKey("queue_members"),
  ...
  class GetMember {
    ...
    void returnsMember() {
      Map<String, Object> result = client.compat().queues().getMember("QU_GM", "CA_GM");
      assertNotNull(result);
      assertTrue(
          result.containsKey("call_sid") || result.containsKey("queue_sid"),
  ...
  class DequeueMember {
    ...
    void returnsMember() {
      Map<String, Object> result =
          client.compat().queues().dequeueMember("QU_DM", "CA_DM", kw("Url", "https://a.b"));
      assertNotNull(result);
    ...
    void journalRecordsPost() {
      client
          .compat()
          .queues()
          .dequeueMember("QU_DMX", "CA_DMX", kw("Url", "https://a.b/url", "Method", "POST"));
      MockTest.JournalEntry j = mock.last();
      assertEquals("POST", j.method);

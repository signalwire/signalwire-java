 ...
 *
 * <p>Both resources expose the same surface (list / get / delete) and use the account-scoped LAML
 * path.
 */
class CompatRecordingsTranscriptionsMockTest {
  ...
  class RecordingsList {
    ...
    void journalRecordsGet() {
      ...
      assertEquals(acctBase + "/Recordings", j.path);
    }
  }
  ...
  class RecordingsGet {
    ...
    void returnsRecordingResource() {
      ...
      assertTrue(
          result.containsKey("sid") || result.containsKey("call_sid"),
    ...
    void journalRecordsGet() {
      ...
      MockTest.JournalEntry j = mock.last();
      assertEquals("GET", j.method);
      assertEquals(acctBase + "/Recordings/RE_GET", j.path);
    }
  }
  ...
  class RecordingsDelete {
    ...
    void journalRecordsDelete() {
      ...
      assertEquals(acctBase + "/Recordings/RE_DEL", j.path);
    }
  }
  ...
  class TranscriptionsList {
    ...
    void returnsPaginatedTranscriptions() {
      ...
      assertNotNull(result);
      assertTrue(
          result.containsKey("transcriptions"),
    ...
    void journalRecordsGet() {
      ...
      MockTest.JournalEntry j = mock.last();
      assertEquals("GET", j.method);
      assertEquals(acctBase + "/Transcriptions", j.path);
    }
  }
  ...
  class TranscriptionsGet {
    ...
    void returnsTranscriptionResource() {
      ...
      assertTrue(
          result.containsKey("sid") || result.containsKey("duration"),
    ...
    void journalRecordsGet() {
      ...
      MockTest.JournalEntry j = mock.last();
      assertEquals("GET", j.method);
      assertEquals(acctBase + "/Transcriptions/TR_GET", j.path);
    }
  }
  ...
  class TranscriptionsDelete {
    ...
    void journalRecordsDelete() {
      ...
      MockTest.JournalEntry j = mock.last();
      assertEquals("DELETE", j.method);
      assertEquals(acctBase + "/Transcriptions/TR_DEL", j.path);
    }
  }
}

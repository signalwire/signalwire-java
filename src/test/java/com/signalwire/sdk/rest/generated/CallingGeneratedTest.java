...
/** AUTO-GENERATED full-mock REST wire tests for the 'calling' namespace. */
class CallingGeneratedTest {
    ...
    dispatch(
        () ->
            client
                ...
                .aiHold(
                    "x",
                    com.signalwire.sdk.rest.namespaces.generated.Calling.AiHoldRequest.builder()
                        .build()));
    MockTest.JournalEntry j = mock.last();
    assertEquals("POST", j.method, "method for calling.call-commands");
    assertEquals(
        "calling.call-commands", j.getMatchedRoute(), "matched_route for calling.call-commands");
  }

  @Test
  void callingAiHoldError() {
    mock.scenarioSet("calling.call-commands", 500, Map.of("error", "x"));
    RestError ex =
        assertThrows(
            RestError.class,
            () ->
                client
                    ...
                    .aiHold(
                        ...
                        com.signalwire.sdk.rest.namespaces.generated.Calling.AiHoldRequest.builder()
                            .build()));
    assertEquals(500, ex.getStatusCode(), "status for calling.call-commands");
    MockTest.JournalEntry j = mock.last();
    assertEquals(
        Integer.valueOf(500), j.getResponseStatus(), "response_status for calling.call-commands");
    assertEquals(
        "calling.call-commands", j.getMatchedRoute(), "matched_route for calling.call-commands");
  }
}

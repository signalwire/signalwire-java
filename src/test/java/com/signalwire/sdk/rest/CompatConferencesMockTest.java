 ...
 *
 * <p>Covers the Conference resource plus participant, recording, and stream sub-collections — the
 * full surface of {@code CompatConferences}.
 */
class CompatConferencesMockTest {
  ...
  class List_ {
    ...
    void returnsPaginatedList() {
      ...
      assertTrue(
          result.containsKey("conferences"), "expected 'conferences' key, got " + result.keySet());
  ...
  class Get {
    ...
    void returnsConference() {
      ...
      assertNotNull(result);
      assertTrue(
          result.containsKey("friendly_name") || result.containsKey("status"),
  ...
  class Update {
    ...
    void returnsUpdated() {
      Map<String, Object> result =
          client.compat().conferences().update("CF_X", kw("Status", "completed"));
      assertNotNull(result);
    ...
    void journalRecordsPost() {
      client
          .compat()
          .conferences()
          .update("CF_UPD", kw("Status", "completed", "AnnounceUrl", "https://a.b"));
      MockTest.JournalEntry j = mock.last();
  ...
  class GetParticipant {
    ...
    void returnsParticipant() {
      Map<String, Object> result = client.compat().conferences().getParticipant("CF_P", "CA_P");
      assertNotNull(result);
      assertTrue(
          result.containsKey("call_sid") || result.containsKey("conference_sid"),
  ...
  class UpdateParticipant {
    ...
    void returnsParticipant() {
      Map<String, Object> result =
          client.compat().conferences().updateParticipant("CF_UP", "CA_UP", kw("Muted", true));
      assertNotNull(result);
    ...
    void journalRecordsPost() {
      client
          .compat()
          .conferences()
          .updateParticipant("CF_M", "CA_M", kw("Muted", true, "Hold", false));
      MockTest.JournalEntry j = mock.last();
      assertEquals("POST", j.method);
  ...
  class RemoveParticipant {
    ...
    void returnsObject() {
      Map<String, Object> result = client.compat().conferences().removeParticipant("CF_R", "CA_R");
      assertNotNull(result);
    }
  ...
  class ListRecordings {
    ...
    void returnsRecordings() {
      Map<String, Object> result = client.compat().conferences().listRecordings("CF_LR");
      assertNotNull(result);
      assertTrue(
          result.containsKey("recordings"), "expected 'recordings' key, got " + result.keySet());
  ...
  class GetRecording {
    ...
    void returnsRecording() {
      Map<String, Object> result = client.compat().conferences().getRecording("CF_GR", "RE_GR");
      assertNotNull(result);
  ...
  class UpdateRecording {
    ...
    void returnsRecording() {
      Map<String, Object> result =
          client.compat().conferences().updateRecording("CF_URC", "RE_URC", kw("Status", "paused"));
      assertNotNull(result);
    ...
    @DisplayName("journal_records_post_with_status")
    void journalRecordsPost() {
      client.compat().conferences().updateRecording("CF_UR", "RE_UR", kw("Status", "paused"));
      MockTest.JournalEntry j = mock.last();
      assertEquals("POST", j.method);
  ...
  class DeleteRecording {
    ...
    void noExceptionOnDelete() {
      Map<String, Object> result = client.compat().conferences().deleteRecording("CF_DR", "RE_DR");
      assertNotNull(result);
    }
  ...
  class StartStream {
    ...
    void returnsStream() {
      Map<String, Object> result =
          client.compat().conferences().startStream("CF_SS", kw("Url", "wss://a.b/s"));
      assertNotNull(result);
    ...
    void journalRecordsPost() {
      client.compat().conferences().startStream("CF_SSX", kw("Url", "wss://a.b/s", "Name", "strm"));
      MockTest.JournalEntry j = mock.last();
      assertEquals("POST", j.method);
  ...
  class StopStream {
    ...
    void returnsStream() {
      Map<String, Object> result =
          client.compat().conferences().stopStream("CF_TS", "ST_TS", kw("Status", "stopped"));
      assertNotNull(result);
      assertTrue(result.containsKey("sid") || result.containsKey("status"));
    }
    ...
    void journalRecordsPost() {
      client.compat().conferences().stopStream("CF_TSX", "ST_TSX", kw("Status", "stopped"));
      MockTest.JournalEntry j = mock.last();
      assertEquals("POST", j.method);

...
class CompatPhoneNumbersMockTest {
  ...
  class List_ {
    ...
    void returnsPaginatedList() {
      ...
      assertTrue(
          result.containsKey("incoming_phone_numbers"),
          "expected 'incoming_phone_numbers' key, got " + result.keySet());
      assertTrue(
          result.get("incoming_phone_numbers") instanceof List,
    ...
    void journalRecordsGet() {
      ...
      assertEquals(acctBase + "/IncomingPhoneNumbers", j.path);
    }
  }
  ...
  class Get {
    ...
    void returnsPhoneNumberResource() {
      ...
      assertTrue(
          result.containsKey("phone_number") || result.containsKey("sid"),
    ...
    void journalRecordsGetWithSid() {
      ...
      MockTest.JournalEntry j = mock.last();
      assertEquals("GET", j.method);
      assertEquals(acctBase + "/IncomingPhoneNumbers/PN_GET", j.path);
    }
  }
  ...
  class Update {
    ...
    void journalRecordsPostWithFriendlyName() {
      ...
      assertEquals(acctBase + "/IncomingPhoneNumbers/PN_UU", j.path);
  ...
  class Delete {
    ...
    void journalRecordsDelete() {
      ...
      assertEquals(acctBase + "/IncomingPhoneNumbers/PN_DEL", j.path);
    }
  }
  ...
  class Import_ {
    ...
    void journalRecordsPost() {
      ...
      assertEquals(acctBase + "/ImportedPhoneNumbers", j.path);
      Map<String, Object> jb = j.bodyMap();
      assertNotNull(jb);
  ...
  class ListAvailableCountries {
    ...
    void returnsCountriesCollection() {
      ...
      assertNotNull(result);
      assertTrue(
          result.containsKey("countries"), "expected 'countries' key, got " + result.keySet());
      assertTrue(
          result.get("countries") instanceof List, "expected list, got " + result.get("countries"));
    }
    ...
    void journalRecordsGet() {
      ...
      MockTest.JournalEntry j = mock.last();
      assertEquals("GET", j.method);
      assertEquals(acctBase + "/AvailablePhoneNumbers", j.path);
    }
  }
  ...
  class SearchTollFree {
    ...
    void returnsAvailableNumbers() {
      ...
      assertNotNull(result);
      assertTrue(
          result.containsKey("available_phone_numbers"),
    ...
    void journalRecordsGet() {
      ...
      MockTest.JournalEntry j = mock.last();
      assertEquals("GET", j.method);
      assertEquals(acctBase + "/AvailablePhoneNumbers/US/TollFree", j.path);
      ...
      assertTrue(qp.containsKey("AreaCode"), "expected AreaCode in query, got " + qp.keySet());

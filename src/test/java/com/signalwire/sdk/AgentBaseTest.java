...
class AgentBaseTest {
  ...
  void testBuilderDefaults() {
    AgentBase defaultAgent =
        AgentBase.builder().name("default-agent").authUser("user").authPassword("pass").build();
  ...
  void testRouteTrailingSlashRemoved() {
    AgentBase a =
        AgentBase.builder().name("agent").route("/api/").authUser("u").authPassword("p").build();
  ...
  void testPromptAddSection() {
    agent.promptAddSection("Personality", "Be friendly.", List.of("Be helpful", "Be concise"));
  ...
  void testToolExecution() {
    ...
    FunctionResult result = agent.onFunctionCall("echo", Map.of("message", "test"), Map.of());
  ...
  void testDefineMultipleTools() {
    ToolDefinition td1 =
        new ToolDefinition("t1", "Tool 1", Map.of(), (a, r) -> new FunctionResult("1"));
    ToolDefinition td2 =
        new ToolDefinition("t2", "Tool 2", Map.of(), (a, r) -> new FunctionResult("2"));

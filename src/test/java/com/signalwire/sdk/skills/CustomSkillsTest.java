...
import com.signalwire.sdk.skills.builtin.CustomSkillsSkill;
...
class CustomSkillsTest {
  ...
  void testToolsHaveHandlers() {
    List<Map<String, Object>> toolDefs = List.of(Map.of("name", "tool", "description", "desc"));
    CustomSkillsSkill skill = new CustomSkillsSkill();
    skill.setup(Map.of("tools", toolDefs));
  ...
  void testToolDescriptions() {
    List<Map<String, Object>> toolDefs =
        List.of(Map.of("name", "tool", "description", "Custom description"));
    CustomSkillsSkill skill = new CustomSkillsSkill();
    skill.setup(Map.of("tools", toolDefs));

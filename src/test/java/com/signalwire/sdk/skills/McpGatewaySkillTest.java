...
class McpGatewaySkillTest {
    ...
    List<Map<String, Object>> services =
        List.of(
            Map.of(
                ...
                "calendar",
                "tools",
                List.of(Map.of("name", "list_events", "description", "List events"))));
    McpGatewaySkill skill = new McpGatewaySkill();
  ...
  void testCustomToolPrefix() {
    ...
    McpGatewaySkill skill = new McpGatewaySkill();
    skill.setup(
        Map.of("gateway_url", "http://localhost:8080", "services", services, "tool_prefix", "gw_"));
    var tools = skill.registerTools();
  ...
  @Test
  void testHints() {
    List<Map<String, Object>> services = List.of(Map.of("name", "calendar", "tools", List.of()));
    McpGatewaySkill skill = new McpGatewaySkill();
    skill.setup(Map.of("gateway_url", "http://localhost:8080", "services", services));

...
class ReceptionistTest {
  ...
  void testCreation() {
    ...
    departments.put(
        "support", ReceptionistAgent.swmlDepartment("Support", "https://support.example.com/swml"));
    ReceptionistAgent prefab = new ReceptionistAgent("test-receptionist", "Welcome!", departments);

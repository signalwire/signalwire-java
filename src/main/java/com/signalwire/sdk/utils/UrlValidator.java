...
public final class UrlValidator {
  ...
  /**
   * Pluggable DNS resolver. Tests inject a fake to keep the suite hermetic; production calls {@link
   * InetAddress#getAllByName(String)}.
   */
  static volatile Function<String, InetAddress[]> resolver =
      hostname -> {
        try {
  ...
  /**
   * Test whether {@code addr} falls inside {@code cidr}. Handles both IPv4 (<code>a.b.c.d/N</code>)
   * and IPv6 (<code>::1/128</code>, <code>fc00::/7</code>, ...).
   */

 ...
 *
 * <p>The Twilio-compatible LAML API is mounted under {@code
 * /api/laml/2010-04-01/Accounts/{AccountSid}}. The trailing {@code /api} prefix is added by {@link
 * HttpClient}, so namespace base paths here begin with {@code /laml/2010-04-01/Accounts/...}.
 */
public class CompatNamespace {
  ...
  public static class CompatCalls extends CrudResource {
    ...
    public Map<String, Object> updateRecording(
      ...
      return getHttpClient()
          .post(getBasePath() + "/" + callSid + "/Recordings/" + recordingSid, body);
    }
    ...
    public Map<String, Object> stopStream(
      ...
      return getHttpClient().post(getBasePath() + "/" + callSid + "/Streams/" + streamSid, body);
    }
  }
  ...
  public static class CompatPhoneNumbers {
    ...
    public CompatPhoneNumbers(HttpClient httpClient, String basePath) {
      ...
      this.availableBase = basePath.replace("/IncomingPhoneNumbers", "/AvailablePhoneNumbers");
      this.importedBase = basePath.replace("/IncomingPhoneNumbers", "/ImportedPhoneNumbers");
    }
   ...
   *
   * <p>Mirrors {@code signalwire.rest.namespaces.compat.CompatAccounts}: accounts.create lives at
   * the top-level {@code /Accounts} collection (no AccountSid prefix); accounts.get/update operate
   * on {@code /Accounts/{sid}}. update is a Twilio-compat POST (not PATCH/PUT).
   */
  ...
  public static class CompatConferences {
    ...
    public Map<String, Object> getParticipant(String conferenceSid, String callSid) {
      return httpClient.get(basePath + "/" + conferenceSid + "/Participants/" + callSid);
    }

    public Map<String, Object> updateParticipant(
        String conferenceSid, String callSid, Map<String, Object> body) {
      return httpClient.post(basePath + "/" + conferenceSid + "/Participants/" + callSid, body);
    }

    public Map<String, Object> removeParticipant(String conferenceSid, String callSid) {
      return httpClient.delete(basePath + "/" + conferenceSid + "/Participants/" + callSid);
    }
    ...
    public Map<String, Object> getRecording(String conferenceSid, String recordingSid) {
      return httpClient.get(basePath + "/" + conferenceSid + "/Recordings/" + recordingSid);
    }

    public Map<String, Object> updateRecording(
        String conferenceSid, String recordingSid, Map<String, Object> body) {
      return httpClient.post(basePath + "/" + conferenceSid + "/Recordings/" + recordingSid, body);
    }

    public Map<String, Object> deleteRecording(String conferenceSid, String recordingSid) {
      return httpClient.delete(basePath + "/" + conferenceSid + "/Recordings/" + recordingSid);
    }
    ...
    public Map<String, Object> stopStream(
      ...
      return httpClient.post(basePath + "/" + conferenceSid + "/Streams/" + streamSid, body);
    }
  }
  ...
  public static class CompatQueues extends CrudResource {
    ...
    public Map<String, Object> dequeueMember(
      ...
      return getHttpClient().post(getBasePath() + "/" + queueSid + "/Members/" + callSid, body);
    }
  }

  /** Compat API token management. Note: update is PATCH (BaseResource style), not POST. */

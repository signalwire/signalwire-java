 ...
 *
 * <p>Supports the standard CRUD surface plus typed helpers for binding an inbound call to a handler
 * (SWML webhook, cXML webhook, AI agent, call flow, RELAY application/topic). The binding model is:
 * set {@code call_handler} + the handler-specific companion field on the phone number; the server
 * auto-materializes the matching Fabric resource. See {@link PhoneCallHandler} for the enum and
 * {@code rest/docs/phone-binding.md} for the full model.
 */
public class PhoneNumbersNamespace {
  ...
  public Map<String, Object> list(Map<String, String> queryParams) {
    return numbers.list(queryParams);
  }
  ...
  public Map<String, Object> create(Map<String, Object> body) {
    return numbers.create(body);
  }

  /** Update a phone number. */
  public Map<String, Object> update(String id, Map<String, Object> body) {
    return numbers.update(id, body);
  }

  /** Release a phone number. */
  public Map<String, Object> delete(String id) {
    return numbers.delete(id);
  }
   ...
   *
   * <p>Your backend returns an SWML document per call. The server auto-creates a {@code
   ...
   *
   * <p>Despite the wire value {@code laml_webhooks} being plural, this creates a single {@code
   * cxml_webhook} Fabric resource.
   *
   * @param id phone number SID
  ...
  /**
   * Route inbound calls to a cXML webhook with optional fallback and status-callback URLs. Pass
   * {@code null} to omit either.
   *
   * @param id phone number SID
   * @param url primary cXML endpoint
  ...
  public Map<String, Object> setCxmlWebhook(
      String id, String url, String fallbackUrl, String statusCallbackUrl) {
    Map<String, Object> body = new LinkedHashMap<>();
   ...
   * @param id phone number SID
   * @param flowId call-flow resource ID
   * @param version {@code "working_copy"}, {@code "current_deployed"}, or {@code null} for the
   *     server default
   */

 ...
 *
 * <p>Mirrors {@code signalwire.rest.namespaces.queues.QueuesResource}: queue CRUD uses PUT for
 * update; members are addressable both per-id and via the special {@code /next} endpoint.
 */

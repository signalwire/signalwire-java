 ...
 *
 * <p>Mirrors {@code signalwire.rest.namespaces.number_groups.NumberGroupsResource}: the group CRUD
 * uses PUT for update; membership get/delete operate against a separate top-level {@code
 * /api/relay/rest/number_group_memberships} collection (not a sub-collection of the group).
 */

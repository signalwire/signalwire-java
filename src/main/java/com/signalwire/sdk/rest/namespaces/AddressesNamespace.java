 ...
 *
 * <p>Mirrors {@code signalwire.rest.namespaces.addresses.AddressesResource}: list / create / get /
 * delete (no update endpoint exists for addresses). Paths sit under {@code

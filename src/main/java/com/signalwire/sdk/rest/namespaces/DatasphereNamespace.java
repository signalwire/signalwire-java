 ...
 *
 * <p>Mirrors {@code signalwire.rest.namespaces.datasphere.DatasphereNamespace}: documents are
 * CRUD-shaped, plus {@code search} (POST) and chunk-level operations.
 */
public class DatasphereNamespace {
  ...
  /**
   * Legacy convenience for knowledge-base search; the canonical entry point is {@link
   * DatasphereDocuments#search(Map)}.
   */

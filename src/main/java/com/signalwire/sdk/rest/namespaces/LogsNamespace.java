 ...
 *
 * <p>Mirrors {@code signalwire.rest.namespaces.logs.LogsNamespace}: each sub-resource fans out to a
 * distinct sub-API root (message → /messaging/logs, voice → /voice/logs, fax → /fax/logs,
 * conference → /logs/conferences).
 */

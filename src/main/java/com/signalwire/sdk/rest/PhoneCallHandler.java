 ...
 * </pre>
 *
 * <p>Note: {@link #LAML_WEBHOOKS} (wire value {@code laml_webhooks}) produces a <b>cXML</b>
 * handler, not a generic webhook. For SWML, use {@link #RELAY_SCRIPT}.
 */
public enum PhoneCallHandler {
  ...
  /**
   * Returns the wire value so this enum serializes transparently into request bodies without an
   * explicit {@code .wireValue()} indirection.
   */
  @Override

...
public class AgentBase extends Service {
  ...
  // Env vars this class reads (via the injected EnvProvider, System.getenv by
  // default). Named as constants so the var names are a single source of truth.
  private static final String ENV_PROXY_URL_BASE = "SWML_PROXY_URL_BASE";
  private static final String ENV_BASIC_AUTH_USER = "SWML_BASIC_AUTH_USER";
  private static final String ENV_BASIC_AUTH_PASSWORD = "SWML_BASIC_AUTH_PASSWORD";
  ...
  public static class Builder {
    ...
    public AgentBase build() {
      ...
      if (resolvedUser == null) {
        String envUser = env.get(ENV_BASIC_AUTH_USER);
      ...
      if (resolvedPass == null) {
        String envPass = env.get(ENV_BASIC_AUTH_PASSWORD);

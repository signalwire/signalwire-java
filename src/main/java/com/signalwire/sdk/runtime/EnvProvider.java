 ...
 *
 * <p>Extracted as an interface so tests can inject a deterministic map instead of relying on actual
 * OS environment variables (which Java cannot mutate at runtime without native hackery).
 *
...
public interface EnvProvider {
  ...
  /**
   * Return the value of the given environment variable, or {@code null} if it is not set.
   *

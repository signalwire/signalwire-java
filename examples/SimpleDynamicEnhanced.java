 ...
 * department=sales/support/billing (specialized expertise) - customer_id=<string> (personalized
 * experience) - language=en/es (language and voice selection)
 *
 * <p>Test: curl "http://localhost:3000/?vip=true&department=sales" curl
 * "http://localhost:3000/?department=billing&language=es"
 */
...
public class SimpleDynamicEnhanced {
  ...
  public static void main(String[] args) throws Exception {
    var agent = AgentBase.builder().name("dynamic-enhanced").route("/").port(3000).build();

    agent.setDynamicConfigCallback(
        (queryParams, bodyParams, headers, ephemeral) -> {
          ...
          ephemeral.defineTool(
              ...
              Map.of(
                  ...
                  "object",
                  "properties",
                  Map.of("order_number", Map.of("type", "string", "description", "Order number"))),
              (toolArgs, raw) -> {

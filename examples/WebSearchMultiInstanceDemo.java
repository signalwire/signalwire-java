 ...
 * quick). Also includes Wikipedia search.
 *
 * <p>Required: GOOGLE_SEARCH_API_KEY, GOOGLE_SEARCH_ENGINE_ID
 */
...
public class WebSearchMultiInstanceDemo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    var agent = AgentBase.builder().name("multi-search").route("/multi-search").port(3000).build();

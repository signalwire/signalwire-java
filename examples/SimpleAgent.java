 ...
 *
 * <p>Test: bin/swaig-test --url http://agent:PASS@localhost:3000 --list-tools bin/swaig-test --url
 * http://agent:PASS@localhost:3000 --exec get_weather --param city=Austin
 */
...
public class SimpleAgent {
  ...
  public static void main(String[] args) throws Exception {
    var agent = AgentBase.builder().name("weather-agent").route("/").port(3000).build();

    // Add prompt sections (Prompt Object Model)
    agent.promptAddSection("Role", "You are a helpful weather assistant.");
    ...
    agent.defineTool(
        ...
        (toolArgs, rawData) -> {
          ...
          return new FunctionResult("The weather in " + city + " is 72F (22C) and sunny.");
        });

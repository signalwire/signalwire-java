 ...
 * `, so the doc code is this compiled, gate-run example and can never drift.
 *
 * <p>Test locally without running a server: bin/swaig-test --url http://user:pass@localhost:3000
 * --list-tools bin/swaig-test --url http://user:pass@localhost:3000 --exec get_time
 */

 ...
 * with different parameter shapes - Post-prompt for conversation summary - Hints for speech
 * recognition
 */
...
public class SwaigFeaturesAgent {
  ...
  public static void main(String[] args) throws Exception {
    var agent =
        AgentBase.builder().name("swaig-features").route("/swaig-features").port(3000).build();
    ...
    agent.defineTool(
        ...
        Map.of(
            ...
            "properties",
            Map.of(
                "location", Map.of("type", "string", "description", "City or location"),
                "units",
                    Map.of(
                        "type",
                        "string",

 ...
 * (standard / premium / enterprise) - Industry-specific prompts (healthcare / finance / retail) -
 * Language and voice selection - A/B testing configuration - Debug mode
 *
 * <p>Try: ?tier=premium&industry=healthcare&lang=es&test_group=B
 */
        ...
        (queryParams, bodyParams, headers, configAgent) -> {
          ...
          if ("healthcare".equals(industry)) {
            configAgent.promptAddSection(
                ...
                "Follow HIPAA compliance. Never provide medical diagnoses.",
                List.of(
            ...
            configAgent.promptAddSection(
                "Customer Service",
                "Focus on satisfaction and sales support.",
                List.of(
          ...
          if ("premium".equals(tier) || "enterprise".equals(tier)) {
            configAgent.promptAddSection(
                ...
                "As a " + tier + " service you have advanced features:",
                List.of(
          ...
          if (debug) {
            configAgent.promptAddSection(
                "Debug Mode", "Debug mode is active. Show reasoning in responses.");
            configAgent.addHints(List.of("debug", "verbose", "reasoning"));
          }

          // --- Global data ---
          configAgent.updateGlobalData(
              Map.of(
                  "service_tier", tier,
                  "industry", industry,

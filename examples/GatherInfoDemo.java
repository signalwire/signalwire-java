 ...
 * are presented one at a time and answers are stored in global_data under the configured output
 * key.
 */
...
public class GatherInfoDemo {
  ...
  public static void main(String[] args) throws Exception {
    var agent =
        AgentBase.builder().name("patient-intake").route("/patient-intake").port(3000).build();
    ...
    step1.setGatherInfo(
        "patient_demographics", null, "Please collect the following patient information.");
    step1.addGatherQuestion("full_name", "What is your full name?");
    step1.addGatherQuestion("date_of_birth", "What is your date of birth?");
    step1.addGatherQuestion(
        "phone_number", "What is your phone number?", "string", true, null, null);
    ...
    step2.setGatherInfo(
        "patient_symptoms", null, "Now let's talk about why you're visiting today.");
    step2.addGatherQuestion("reason_for_visit", "What is the main reason for your visit today?");
    step2.addGatherQuestion(
        "symptom_duration", "How long have you been experiencing these symptoms?");
    step2.addGatherQuestion(
        "pain_level", "On a scale of 1 to 10, how would you rate your discomfort?");

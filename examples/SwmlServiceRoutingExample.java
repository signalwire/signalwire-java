 ...
 * the path -- all from a single Service instance.
 *
 * <p>Paths served: /main -> Default greeting /customer -> Customer service greeting /product ->
 * Product information greeting
 */
...
public class SwmlServiceRoutingExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    productSvc.play(
        Map.of("url", "say:We offer voice, video, and messaging APIs for modern applications."));
    productSvc.hangup();

 ...
 * navigation targets, and function restrictions.
 */
...
public class ContextsDemo {
  ...
  public static void main(String[] args) throws Exception {
    var agent = AgentBase.builder().name("onboarding-agent").route("/").port(3000).build();

    agent.promptAddSection("Role", "You are an onboarding assistant. Guide users through setup.");
    ...
    welcomeStep.setText("Greet the user and ask for their name and email.");
    welcomeStep.setStepCriteria("User has provided their name and email address.");
    ...
    prefsStep.setText("Ask about the user's preferences and interests.");
    prefsStep.setStepCriteria("User has shared at least 2 preferences.");
    ...
    confirmStep.setText("Summarize the collected information and confirm with the user.");
    confirmStep.setStepCriteria("User has confirmed their information is correct.");
    ...
    agent.defineTool(
        ...
        Map.of(
            ...
            "object",
            "properties",
            Map.of("preference", Map.of("type", "string", "description", "User preference")),
            "required",
            List.of("preference")),
        (toolArgs, raw) -> new FunctionResult("Saved preference: " + toolArgs.get("preference")));

    agent.defineTool(
        "finalize_onboarding",
        "Complete the onboarding process",
        Map.of("type", "object", "properties", Map.of()),
        (toolArgs, raw) -> new FunctionResult("Onboarding complete! Welcome aboard."));

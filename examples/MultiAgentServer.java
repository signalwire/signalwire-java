...
public class MultiAgentServer {
  ...
  public static void main(String[] args) throws Exception {
    // Create Sales agent
    var salesAgent = AgentBase.builder().name("sales-agent").route("/sales").build();
    salesAgent.promptAddSection("Role", "You are a sales representative for Acme Corp.");
    salesAgent.promptAddSection(
        "Instructions",
        "",
        List.of(
    ...
    salesAgent.defineTool(
        ...
        Map.of(
            ...
            "object",
            "properties",
            Map.of("product", Map.of("type", "string", "description", "Product name"))),
        (toolArgs, raw) -> {
    ...
    var supportAgent = AgentBase.builder().name("support-agent").route("/support").build();
    supportAgent.promptAddSection("Role", "You are a technical support specialist.");
    supportAgent.promptAddSection(
        "Instructions",
        "",
        List.of(
    ...
    supportAgent.defineTool(
        ...
        (toolArgs, raw) -> new FunctionResult("Ticket created: " + toolArgs.get("subject")));

 ...
 * personalization from query parameters.
 *
 * <p>Try: ?user_name=Alice&topic=AI&mood=professional
 */
...
public class CustomPathAgent {
  ...
  public static void main(String[] args) throws Exception {
    ...
    agent.promptAddSection(
        "Role", "You are a friendly chat assistant ready to help with any questions.");
    ...
    agent.setDynamicConfigCallback(
        (queryParams, bodyParams, headers, configAgent) -> {
          ...
          switch (mood) {
            case "professional" ->
                configAgent.promptAddSection(
                    "Communication Style", "Maintain a professional, business-appropriate tone.");
            case "casual" ->
                configAgent.promptAddSection(
                    "Communication Style", "Use a casual, relaxed conversational style.");
            default ->
                configAgent.promptAddSection(
                    "Communication Style",

        ...
        new SurveyAgent(
            ...
            List.of(
                SurveyAgent.ratingQuestion(
                    "On a scale of 1 to 10, how satisfied are you with our service?", 1, 10),
                SurveyAgent.multipleChoiceQuestion(
                    "Which department did you interact with?",
                    List.of("Sales", "Support", "Billing", "Other")),
                SurveyAgent.yesNoQuestion("Would you recommend our service to others?"),
                SurveyAgent.openEndedQuestion("Is there anything else you would like to share?"),
                SurveyAgent.ratingQuestion(
                    "How likely are you to use our service again? (1-5)", 1, 5)),

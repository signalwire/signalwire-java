 ...
 * InfoGathererAgent prefab with that set. Demonstrates how to swap question packs without
 * recompiling: the same agent binary serves "support", "medical", or "onboarding" depending on how
 * it's invoked.
 *
 * <p>Usage: java DynamicInfoGatherer # default set java DynamicInfoGatherer support # customer
 * support questions java DynamicInfoGatherer medical # medical intake java DynamicInfoGatherer
...
public class DynamicInfoGathererExample {
  ...
  public static void main(String[] args) throws Exception {
    Map<String, List<Map<String, Object>>> questionSets =
        Map.of(
            "default",
                List.of(
            ...
            "support",
                List.of(
                    ...
                    InfoGathererAgent.question(
                        "account_number", "What is your account number?", true, null),
            ...
            "medical",
                List.of(
                    ...
                    InfoGathererAgent.question(
                        "symptoms", "What symptoms are you experiencing?", true, null),
    ...
    List<Map<String, Object>> questions =
        questionSets.getOrDefault(set, questionSets.get("default"));

 ...
 * Compare with JokeAgent.java (raw data_map).
 *
 * <p>Required: API_NINJAS_KEY environment variable.
 */
...
public class JokeSkillDemo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    var agent = AgentBase.builder().name("joke-skill-demo").route("/joke-skill").port(3000).build();

 ...
 * etc.) instead of going through Document.addVerb(). Builds voicemail, IVR, and call transfer
 * services that share a single Service instance per route.
 */
  ...
  public static void main(String[] args) throws Exception {
    ...
    voicemail.record(
        Map.of(
            ...
            "#",
            "status_url",
            "https://example.com/voicemail-status"));
    ...
    transfer.connect(
        Map.of(
            ...
            30,
            "parallel",
            List.of(Map.of("to", "+15552223333"), Map.of("to", "+15554445555"))));

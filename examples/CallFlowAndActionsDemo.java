 ...
 * answering) Phase 2: Answer with recording Phase 3: Post-answer verbs Phase 4: AI agent
 * conversation Phase 5: Post-AI verbs (e.g., cleanup, hangup)
 */
...
public class CallFlowAndActionsDemo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    agent.addPostAnswerVerb(
        "play", Map.of("url", "say:Please wait while we connect you with our AI assistant."));

    // Phase 4: AI configuration
    agent.promptAddSection("Role", "You are a customer service representative for TechCorp.");
    ...
    agent.setPostPrompt("Summarize the call: what was the issue, what was the resolution.");
    ...
    agent.defineTool(
        ...
        Map.of(
            ...
            "object",
            "properties",
            Map.of("reason", Map.of("type", "string", "description", "Reason for escalation")),
            "required",
            List.of("reason")),
        (toolArgs, raw) ->
            new FunctionResult("Transferring you to a human agent for: " + toolArgs.get("reason"))

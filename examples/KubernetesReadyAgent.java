 ...
 * (built-in) - Environment variable configuration (PORT, LOG_LEVEL) - Graceful operation
 *
 * <p>Usage: PORT=8080 java KubernetesAgent
 */
...
public class KubernetesReadyAgent {
  ...
  public static void main(String[] args) throws Exception {
    ...
    var agent = AgentBase.builder().name("k8s-agent").route("/").build();
    ...
    agent.defineTool(
        ...
        (toolArgs, raw) ->
            new FunctionResult("Agent k8s-agent is healthy, running in Kubernetes."));

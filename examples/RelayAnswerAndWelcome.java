 ...
 *
 * <ul>
 *   <li>{@code SIGNALWIRE_PROJECT_ID} -- SignalWire project ID
 *   <li>{@code SIGNALWIRE_API_TOKEN} -- SignalWire API token
 *   <li>{@code SIGNALWIRE_SPACE} -- e.g. {@code example.signalwire.com}
 * </ul>
 *
 * <p>Optional:
 *
 * <ul>
 *   <li>{@code SIGNALWIRE_CONTEXT} -- defaults to {@code default}
 *   <li>{@code SIGNALWIRE_LOG_LEVEL=debug} for the full RELAY trace
 * </ul>
 */

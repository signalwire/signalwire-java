...
public class RoomAndSipExample {
  ...
  public static void main(String[] args) throws Exception {
    var agent = AgentBase.builder().name("room-sip-agent").route("/").port(3000).build();
    ...
    agent.defineTool(
        "join_support_room",
        "Join the support team room",
        Map.of("type", "object", "properties", Map.of()),
        (toolArgs, raw) ->
            new FunctionResult("Joining the support team room")
    ...
    agent.defineTool(
        "transfer_to_manager",
        "Transfer call to manager via SIP",
        Map.of("type", "object", "properties", Map.of()),
        (toolArgs, raw) ->
            new FunctionResult("Transferring to manager")
    ...
    agent.defineTool(
        ...
        Map.of(
            ...
            "object",
            "properties",
            Map.of("name", Map.of("type", "string", "description", "Conference name")),
            "required",
            List.of("name")),
        (toolArgs, raw) -> {

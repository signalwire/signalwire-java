 ...
 *
 * <p>Required: SIGNALWIRE_SPACE, SIGNALWIRE_PROJECT_ID, SIGNALWIRE_API_TOKEN,
 * DATASPHERE_DOCUMENT_ID Optional: DATASPHERE_COUNT, DATASPHERE_DISTANCE, DATASPHERE_TAGS
 */
...
public class DatasphereServerlessEnv {
  ...
  public static void main(String[] args) throws Exception {
    ...
    double distance =
        Double.parseDouble(System.getenv().getOrDefault("DATASPHERE_DISTANCE", "4.0"));

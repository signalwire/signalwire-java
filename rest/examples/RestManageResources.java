 ...
 * type="ai_agent"} — Python's dedicated {@code fabric.ai_agents} accessor is not ported (see {@code
 * PORT_OMISSIONS.md}). Phone-number search uses the {@code Map<String,String>} query-param
 * contract; pass all values as strings.
 *
 * <p>Set these env vars: SIGNALWIRE_PROJECT_ID - your SignalWire project ID SIGNALWIRE_API_TOKEN -
 * your SignalWire API token SIGNALWIRE_SPACE - your SignalWire space (e.g. example.signalwire.com)
 *
 * <p>For full HTTP debug output: SIGNALWIRE_LOG_LEVEL=debug
 */
        ...
        client
            ...
            .create(
                Map.of(
                    ...
                    "Demo Support Bot",
                    "prompt",
                    Map.of("text", "You are a friendly support agent for Acme Corp.")));
        ...
        client
            ...
            .search(
                Map.of(
                    "areacode", "512",
                    "max_results", "3"));
    // AvailablePhoneNumbersResponse is a pure-data DTO with no toString(); concatenating it printed
    // the
    // identity hash ("AvailablePhoneNumbersResponse@4488aabb") instead of any result. The results
    // live on
    // `data`.
    System.out.println("  Available: " + available.data);

 ...
 * document per inbound call. You set call_handler on the phone number; the server auto-materializes
 * a swml_webhook Fabric resource pointing at your URL. You do NOT need to create the Fabric webhook
 * resource manually; you do NOT call assign_phone_route.
 *
 ...
 * PHONE_NUMBER_SID - SID of a phone number you own (pn-...) SWML_WEBHOOK_URL - your backend's SWML
 * endpoint
 */
...
public class RestBindPhoneToSwmlWebhook {
  ...
  public static void main(String[] args) {
    ...
    var client = RestClient.builder().project(project).token(token).space(space).build();
    ...
    System.out.printf(
        "  calling_handler_resource_id (server-derived) = %s%n",

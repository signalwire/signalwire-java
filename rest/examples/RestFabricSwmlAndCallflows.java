 ...
 * Call flows live under {@code client.fabric().callFlows()} — the typed sub-namespace that mirrors
 * Python's {@code fabric.call_flows}.
 *
...
public class RestFabricSwmlAndCallflows {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("\nCreating call flow...");
    try {
      var callFlow = client.fabric().callFlows().create(Map.of("title", "main-routing"));

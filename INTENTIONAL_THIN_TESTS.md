...
- src/test/java/com/signalwire/sdk/skills/WebSearchSkillTest.java:233 — AutoCloseable.close() on the in-test StubServer that mimics Google CSE; teardown helper invoked via try-with-resources, exercised by every @Test that uses the stub
